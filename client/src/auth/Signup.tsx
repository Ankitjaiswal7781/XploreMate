  ...
  return (
    <div className="flex items-center justify-center min-h-screen text-center">
      <form onSubmit={loginSubmitHandler} className="md:p-8 w-full max-w-md rounded-lg md:border border-gray-200 mx-4">
        ...
        <div className="mb-10">
            {
              loading ? (<Button disabled className="w-full bg-purple hover:bg-hoverPurple"><Loader2 className="mr-2 h-4 w-4 animate-spin"/>Please wait</Button>) :
              (<Button type="submit" className="w-full bg-purple hover:bg-hoverPurple">Signup</Button>)
            }
        </div>
        <Separator/>
        <p className="mt-2">
