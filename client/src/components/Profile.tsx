...
const Profile = () => {
  ...
  return (
    <form
      ...
      className="max-w-7xl mx-auto my-5 mt-20 p-5"
    >
      ...
      <div className="text-center">
        {isLoading ? (
          <Button
            disabled
            className="bg-purple hover:bg-hoverPurple dark:bg-purple-700 dark:hover:bg-purple-600"
          >
            <Loader2 className="mr-2 w-4 h-4 animate-spin" />
            Please wait!
          </Button>
        ) : (
          <Button className="bg-purple hover:bg-hoverPurple dark:bg-purple-700 dark:hover:bg-purple-600">
            Update
          </Button>
        )}
      </div>
